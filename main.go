...
func main() {
	...
	//проверка ввода на наличие оператора, при том ТОЛЬКО ОДНОГО
	...
	//проверка ввода на то что оператор стоит там где надо, а именно посередине между числами (иначе строка неправильно поделится на слайсы)
